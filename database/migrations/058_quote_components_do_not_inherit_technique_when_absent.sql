-- ============================================================
-- 058_quote_components_do_not_inherit_technique_when_absent.sql
--
-- Corrige H-057-001: cuando p_id_tecnica es NULL, la funcion no debe
-- resolver una fila cualquiera de producto_tecnica ni heredar merma/setup de
-- una tecnica no solicitada. La cotizacion sin tecnica usa cantidad de
-- produccion igual a p_cantidad y metadata merma_pct=0.
-- ============================================================
...
COMMENT ON FUNCTION fn_calculate_quote_components(UUID, UUID, INTEGER, UUID, INTEGER, NUMERIC, TEXT, TIMESTAMPTZ, TEXT) IS
    'Corregido hasta 058: solo ADMIN; aplica redondeo comercial; usa snapshot curado para marcacion explicita; valida preparaciones; no hereda merma/setup cuando no se solicita tecnica.';
