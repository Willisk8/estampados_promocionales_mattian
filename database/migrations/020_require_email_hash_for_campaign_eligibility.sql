-- ============================================================
-- 020_require_email_hash_for_campaign_eligibility.sql
-- Fail-closed para canales EMAIL sin HMAC.
--
-- Si email_hash es NULL o vacio, el canal no puede ser elegible porque no
-- puede comprobarse contra supresion global.
-- ============================================================
...
COMMENT ON FUNCTION fn_email_eligible_for_campaign(UUID) IS
    'Evalua elegibilidad por canal; exige email_hash para respetar supresion global.';
